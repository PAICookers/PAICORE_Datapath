...
# module references:
# PAICORE_recv, PAICORE_regfile, PAICORE_send
...
proc create_hier_cell_pl_datapath { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net PAICORE_recv_0_m_axis [get_bd_intf_pins PAICORE_recv_0/m_axis] [get_bd_intf_pins xdma_0/S_AXIS_C2H_0]
  ...
  connect_bd_net -net PAICORE_recv_0_acknowledge [get_bd_pins PAICORE_recv_0/acknowledge] [get_bd_pins PAICORE_send_0/acknowledge]
  connect_bd_net -net PAICORE_recv_0_o_rx_done [get_bd_pins PAICORE_recv_0/o_rx_done] [get_bd_pins PAICORE_regfile_0/i_rx_done]
  ...
  connect_bd_net -net PAICORE_regfile_0_DataPath_Reset_n [get_bd_pins PAICORE_recv_0/m_axis_aresetn] [get_bd_pins PAICORE_regfile_0/DataPath_Reset_n] [get_bd_pins PAICORE_send_0/s_axis_aresetn]
  connect_bd_net -net PAICORE_regfile_0_PAICORE_CTRL [get_bd_pins PAICORE_regfile_0/PAICORE_CTRL] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net PAICORE_send_0_data_cnt [get_bd_pins PAICORE_regfile_0/data_cnt] [get_bd_pins PAICORE_send_0/data_cnt]
  connect_bd_net -net PAICORE_send_0_dout [get_bd_pins PAICORE_recv_0/din] [get_bd_pins PAICORE_send_0/dout]
  connect_bd_net -net PAICORE_send_0_o_tx_done [get_bd_pins PAICORE_regfile_0/i_tx_done] [get_bd_pins PAICORE_send_0/o_tx_done]
  connect_bd_net -net PAICORE_send_0_request [get_bd_pins PAICORE_recv_0/request] [get_bd_pins PAICORE_send_0/request]
  ...
  connect_bd_net -net PAICORE_send_0_tlast_cnt [get_bd_pins PAICORE_regfile_0/tlast_cnt] [get_bd_pins PAICORE_send_0/tlast_cnt]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_aclk] [get_bd_pins PAICORE_recv_0/m_axis_aclk] [get_bd_pins PAICORE_regfile_0/S_AXI_ACLK] [get_bd_pins PAICORE_send_0/s_axis_aclk] [get_bd_pins xdma_0/axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins axi_aresetn] [get_bd_pins PAICORE_regfile_0/S_AXI_ARESETN] [get_bd_pins xdma_0/axi_aresetn]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins PAICORE_recv_0/i_recv_done] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins PAICORE_recv_0/i_recv_busy] [get_bd_pins xlslice_1/Dout]
