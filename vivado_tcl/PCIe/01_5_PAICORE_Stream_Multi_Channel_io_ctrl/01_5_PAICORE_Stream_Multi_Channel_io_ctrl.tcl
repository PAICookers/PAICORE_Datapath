...
# module references:
# PAICORE_regfile, PAICORE_transfer, timeMeasure
...
proc create_hier_cell_pl_datapath { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir IO -from 3 -to 0 ACK
  create_bd_pin -dir O -from 2 -to 0 E_CTRL
  create_bd_pin -dir IO -from 127 -to 0 PDATA
  create_bd_pin -dir IO -from 3 -to 0 REQ
  ...
  # Create instance: PAICORE_transfer_0, and set properties
  set block_name PAICORE_transfer
  set block_cell_name PAICORE_transfer_0
  if { [catch {set PAICORE_transfer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PAICORE_transfer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_RF] [get_bd_intf_pins PAICORE_regfile_0/s_axil]
  connect_bd_intf_net -intf_net PAICORE_transfer_0_m_axis [get_bd_intf_pins PAICORE_transfer_0/m_axis] [get_bd_intf_pins xdma_0/S_AXIS_C2H_0]
  connect_bd_intf_net -intf_net xdma_0_M_AXIS_H2C_0 [get_bd_intf_pins PAICORE_transfer_0/s_axis] [get_bd_intf_pins xdma_0/M_AXIS_H2C_0]
  ...
  connect_bd_net -net Net [get_bd_pins PDATA] [get_bd_pins PAICORE_transfer_0/pdata]
  connect_bd_net -net Net1 [get_bd_pins REQ] [get_bd_pins PAICORE_transfer_0/request]
  connect_bd_net -net Net2 [get_bd_pins ACK] [get_bd_pins PAICORE_transfer_0/acknowledge]
  connect_bd_net -net PAICORE_recv_0_o_rx_done [get_bd_pins PAICORE_regfile_0/i_rx_done] [get_bd_pins PAICORE_transfer_0/o_rx_done] [get_bd_pins timeMeasure_0/recv_done]
  connect_bd_net -net PAICORE_regfile_0_DataPath_Reset_n [get_bd_pins PAICORE_regfile_0/DataPath_Reset_n] [get_bd_pins PAICORE_transfer_0/m_axis_aresetn] [get_bd_pins PAICORE_transfer_0/s_axis_aresetn] [get_bd_pins timeMeasure_0/rst_n]
  connect_bd_net -net PAICORE_regfile_0_PAICORE_CTRL [get_bd_pins E_CTRL] [get_bd_pins PAICORE_regfile_0/PAICORE_CTRL]
  connect_bd_net -net PAICORE_regfile_0_oFrameNumMax [get_bd_pins PAICORE_regfile_0/oFrameNumMax] [get_bd_pins PAICORE_transfer_0/oFrameNumMax]
  connect_bd_net -net PAICORE_regfile_0_o_rx_rcving [get_bd_pins PAICORE_regfile_0/o_rx_rcving] [get_bd_pins PAICORE_transfer_0/i_rx_rcving]
  connect_bd_net -net PAICORE_regfile_0_oen [get_bd_pins PAICORE_regfile_0/oen] [get_bd_pins PAICORE_transfer_0/oen]
  connect_bd_net -net PAICORE_regfile_0_send_len [get_bd_pins PAICORE_regfile_0/send_len] [get_bd_pins PAICORE_transfer_0/send_len]
  connect_bd_net -net PAICORE_regfile_0_single_channel [get_bd_pins PAICORE_regfile_0/single_channel] [get_bd_pins PAICORE_transfer_0/single_channel]
  connect_bd_net -net PAICORE_regfile_0_single_channel_mask [get_bd_pins PAICORE_regfile_0/single_channel_mask] [get_bd_pins PAICORE_transfer_0/single_channel_mask]
  connect_bd_net -net PAICORE_send_0_o_tx_done [get_bd_pins PAICORE_regfile_0/i_tx_done] [get_bd_pins PAICORE_transfer_0/o_tx_done] [get_bd_pins timeMeasure_0/send_done]
  connect_bd_net -net PAICORE_send_XC_0_write_hsked [get_bd_pins PAICORE_regfile_0/cpu2fifo_plus] [get_bd_pins PAICORE_regfile_0/fifo2snn_plus] [get_bd_pins PAICORE_transfer_0/write_hsked]
  connect_bd_net -net PAICORE_transfer_0_data_cnt [get_bd_pins PAICORE_regfile_0/data_cnt] [get_bd_pins PAICORE_transfer_0/data_cnt]
  connect_bd_net -net PAICORE_transfer_0_read_data [get_bd_pins PAICORE_regfile_0/read_data] [get_bd_pins PAICORE_transfer_0/read_data]
  connect_bd_net -net PAICORE_transfer_0_read_hsked [get_bd_pins PAICORE_regfile_0/fifo2cpu_plus] [get_bd_pins PAICORE_transfer_0/read_hsked]
  connect_bd_net -net PAICORE_transfer_0_snn_out_hsked [get_bd_pins PAICORE_regfile_0/snn2fifo_plus] [get_bd_pins PAICORE_transfer_0/snn_out_hsked]
  connect_bd_net -net PAICORE_transfer_0_write_data [get_bd_pins PAICORE_regfile_0/write_data] [get_bd_pins PAICORE_transfer_0/write_data]
  connect_bd_net -net i_recv_busy_0_1 [get_bd_pins i_recv_busy_0] [get_bd_pins PAICORE_transfer_0/i_recv_busy]
  connect_bd_net -net i_recv_done_0_1 [get_bd_pins i_recv_done_0] [get_bd_pins PAICORE_transfer_0/i_recv_done]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins PAICORE_regfile_0/rst] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_aclk] [get_bd_pins PAICORE_regfile_0/clk] [get_bd_pins PAICORE_transfer_0/m_axis_aclk] [get_bd_pins PAICORE_transfer_0/s_axis_aclk] [get_bd_pins timeMeasure_0/clk] [get_bd_pins xdma_0/axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins axi_aresetn] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xdma_0/axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ACK [ create_bd_port -dir IO -from 3 -to 0 ACK ]
  ...
  set PDATA [ create_bd_port -dir IO -from 127 -to 0 PDATA ]
  set REQ [ create_bd_port -dir IO -from 3 -to 0 REQ ]
  set W_CTRL [ create_bd_port -dir O -from 2 -to 0 W_CTRL ]
  ...
  connect_bd_net -net Net [get_bd_ports PDATA] [get_bd_pins pl_datapath/PDATA]
  connect_bd_net -net Net1 [get_bd_ports REQ] [get_bd_pins pl_datapath/REQ]
  connect_bd_net -net Net2 [get_bd_ports ACK] [get_bd_pins pl_datapath/ACK]
  ...
  connect_bd_net -net pl_datapath_PAICORE_CTRL_0 [get_bd_ports E_CTRL] [get_bd_ports W_CTRL] [get_bd_pins pl_datapath/E_CTRL]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins pl_datapath/axi_aclk] [get_bd_pins xdma_0_axi_periph/ACLK] [get_bd_pins xdma_0_axi_periph/M00_ACLK] [get_bd_pins xdma_0_axi_periph/M01_ACLK] [get_bd_pins xdma_0_axi_periph/S00_ACLK] [get_bd_pins xdma_0_axi_periph_1/ACLK] [get_bd_pins xdma_0_axi_periph_1/M00_ACLK] [get_bd_pins xdma_0_axi_periph_1/M01_ACLK] [get_bd_pins xdma_0_axi_periph_1/S00_ACLK]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x50000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces pl_datapath/xdma_0/M_AXI_BYPASS] [get_bd_addr_segs pl_datapath/PAICORE_regfile_0/s_axil/reg0] -force
