...
# module references:
# PAICORE_recv, PAICORE_regfile, PAICORE_send, timeMeasure
...
proc create_hier_cell_pl_datapath { parentCell nameHier } {
  ...
  connect_bd_net -net PAICORE_regfile_0_DataPath_Reset_n [get_bd_pins PAICORE_recv_0/m_axis_aresetn] [get_bd_pins PAICORE_regfile_0/DataPath_Reset_n] [get_bd_pins PAICORE_send_0/s_axis_aresetn] [get_bd_pins timeMeasure_0/rst_n]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_aclk] [get_bd_pins PAICORE_recv_0/m_axis_aclk] [get_bd_pins PAICORE_regfile_0/S_AXI_ACLK] [get_bd_pins PAICORE_send_0/s_axis_aclk] [get_bd_pins timeMeasure_0/clk] [get_bd_pins xdma_0/axi_aclk]
